        ...
        <div className="scraper-form">
            ...
            <form className="scraper-form__form" onSubmit={handleSubmit}>
                <div className={`scraper-form__field${error ? ` scraper-form__error` : ``}`}>
                    <input type="text" aria-label="Enter Url to scrape a Website" onChange={handleChange} placeholder="http(s)://exapmle.com" id="scraper-form-search" name="scraper-form-search" value={value} className="scraper-form__input"></input>
